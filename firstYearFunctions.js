...
if(dlBSPhDAssessmentInterview) {
  ...
  dlBSPhDAssessmentInterview.disabled = true;
}
...
if(dlFinishTentative) {
  ...
  dlFinishTentative.disabled = true;  
}
...
if(dlChooseSupervisor) {
  ...
  dlChooseSupervisor.disabled = true;
}
...
if(dlChooseSupervisorCommittee) {
  ...
  dlChooseSupervisorCommittee.disabled = true;
}
...
if(dlBSPhDChooseSupervisorCommittee) {
  ...
  dlBSPhDChooseSupervisorCommittee.disabled = true;
}
...
if(dlSelectResearchTopic) {
  ...
  dlSelectResearchTopic.disabled = true;
}
